# A-Coder CLI Project Context

A-Coder CLI is an open-source AI agent that brings the power of Gemini directly
...
- **Architecture:** Monorepo structure using npm workspaces.
  ...
  - `packages/sdk`: Programmatic SDK for embedding A-Coder CLI capabilities.
...
- **Test Commands:**
  ...
  - **Workspace-Specific:** `npm test -w <pkg> -- <path>` (Note: `<path>` must
    ...
    `-w @the-a-tech-corporation/a-coder-cli-core -- src/routing/modelRouterService.test.ts`)
