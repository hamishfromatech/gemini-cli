# A-Coder CLI DevTools

Integrated Developer Tools for A-Coder CLI, providing a Chrome DevTools-like
...
| -------------------------------- | --------------------------------------------- |
| `A_CODER_CLI_ACTIVITY_LOG_TARGET` | File path for JSONL mode (optional, fallback) |
