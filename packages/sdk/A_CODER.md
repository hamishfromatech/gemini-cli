# A-Coder CLI SDK (`@the-a-tech-corporation/sdk`)

Programmatic SDK for embedding A-Coder CLI agent capabilities into other
applications.
...
- Run tests: `npm test -w @the-a-tech-corporation/sdk`
