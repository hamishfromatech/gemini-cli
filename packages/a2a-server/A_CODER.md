# A-Coder CLI A2A Server (`@the-a-tech-corporation/a-coder-cli-a2a-server`)

Experimental Agent-to-Agent (A2A) server that exposes A-Coder CLI capabilities
...
- Run tests: `npm test -w @the-a-tech-corporation/a-coder-cli-a2a-server`
