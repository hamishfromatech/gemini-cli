# RFC: A-Coder CLI A2A Development-Tool Extension

## 1. Introduction

### 1.1 Overview

To standardize client integrations with the A-Coder CLI agent, this document
...
required for rich, interactive workflows with the A-Coder CLI agent.

### 1.2 Motivation

Recent work integrating A-Coder CLI with clients like Zed and Gemini Code
...
- **Ecosystem Alignment**: Aligns A-Coder CLI with a growing industry standard,
...
workflows between a client and the A-Coder CLI agent. It consists of a
...
```json
{
  "name": "A-Coder CLI Agent",
  "description": "An agent that generates code based on natural language instructions.",
  "capabilities": {
    "streaming": true,
    "extensions": [
      {
        "uri": "https://github.com/hamishfromatech/a-coder-cli/blob/main/docs/a2a/developer-profile/v0/spec.md",
...
// Configuration settings for the A-Coder CLI agent.
