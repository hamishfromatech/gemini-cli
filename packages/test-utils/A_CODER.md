# A-Coder CLI Test Utils (`@the-a-tech-corporation/test-utils`)
...
1. **Programmatic Builder:**
   ...
   ```typescript
   import { TestMcpServerBuilder } from '@the-a-tech-corporation/test-utils';
...
Import from `@the-a-tech-corporation/test-utils` in test files across the monorepo.
