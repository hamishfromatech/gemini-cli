...
A-Coder CLI extension. It demonstrates how to expose tools and prompts to the
A-Coder CLI.
...
- `a-coder-extension.json`: The configuration file that tells A-Coder CLI how to
  use this extension.
...
This example is typically used by `a-coder-cli extensions new`.
