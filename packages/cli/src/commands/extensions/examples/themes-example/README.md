...
This is an example of a A-Coder CLI extension that adds a custom theme.
...
1.  Link this extension:
    ...
    ```bash
    a-coder-cli extensions link packages/cli/src/commands/extensions/examples/themes-example
    ```

2.  Set the theme in your settings file (`~/.a-coder/settings.json`):
...
3.  **Observe the Changes:**
    ...
    as defined in this extension's `a-coder-extension.json` file.
