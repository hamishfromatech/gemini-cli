...
// File for 'a-coder-cli mcp add' command
import type { CommandModule } from 'yargs';
import { loadSettings, SettingScope } from '../../config/settings.js';
import { debugLogger, type MCPServerConfig } from '@the-a-tech-corporation/core';
...
export const addCommand: CommandModule = {
  ...
  builder: (yargs) =>
    yargs
      .usage('Usage: a-coder-cli mcp add [options] <name> <commandOrUrl> [args...]')
      .parserConfiguration({
