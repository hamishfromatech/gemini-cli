...
import { ACoderSpinner } from './ACoderSpinner.js';

interface ACoderRespondingSpinnerProps {
  /**
...
export const ACoderRespondingSpinner: React.FC<
  ACoderRespondingSpinnerProps
> = ({
