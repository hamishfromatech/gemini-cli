...
import { makeFakeConfig, ExitCodes } from '@the-a-tech-corporation/core';
...
describe('FolderTrustDialog', () => {
  ...
  it('should render the dialog with title and description', async () => {
    ...
    expect(lastFrame()).toContain(
      'Trusting a folder allows A-Coder CLI to load its local configurations',
    );
    unmount();
  });
  ...
  it('should display restart message when isRestarting is true', async () => {
    ...
    expect(lastFrame()).toContain('A-Coder CLI is restarting');
    unmount();
  });
