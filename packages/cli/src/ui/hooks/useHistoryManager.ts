...
import type { ChatRecordingService } from '@the-a-tech-corporation/core/src/services/chatRecordingService.js';
    ...
    (
      ...
      if (!isResuming && chatRecordingService) {
        switch (itemData.type) {
          ...
          case 'gemini':
          case 'gemini_content':
            // Core conversation recording handled by ACoderChat.
            break;
          default:
            // Ignore the rest.
            break;
