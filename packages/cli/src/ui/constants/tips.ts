...
export const INFORMATIVE_TIPS = [
  ...
  'Toggle respect for .a-coder-ignore files in context (/settings)…',
  ...
  'Show A-Coder CLI status in the terminal window title (/settings)…',
  ...
  'Create a project-specific A_CODER.md file with /init',
  ...
  'Reload instructional context from A_CODER.md files with /memory reload',
  'List the paths of the A_CODER.md files in use with /memory list',
