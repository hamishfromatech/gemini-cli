...
export const INFORMATIVE_TIPS = [
  ...
  'Create a project-specific A-Coder.md file with /init',
  ...
  'Reload instructional context from A-Coder.md files with /memory reload',
  'List the paths of the A-Coder.md files in use with /memory list',
