...
import { isGitRepository, debugLogger } from '@the-a-tech-corporation/core';
...
describe('getInstallationInfo', () => {
  ...
  it('should detect global pnpm installation', () => {
    const pnpmPath = `/Users/test/.pnpm/global/5/node_modules/.pnpm/some-hash/node_modules/@the-a-tech-corporation/a-coder-cli/dist/index.js`;
    ...
    expect(info.isGlobal).toBe(true);
    expect(info.updateCommand).toBe('pnpm add -g @the-a-tech-corporation/a-coder-cli@latest');
  ...
  it('should detect global yarn installation', () => {
    const yarnPath = `/Users/test/.yarn/global/node_modules/@the-a-tech-corporation/a-coder-cli/dist/index.js`;
    ...
    expect(info.updateCommand).toBe(
      'yarn global add @the-a-tech-corporation/a-coder-cli@latest',
    );
    expect(info.updateMessage).toContain('Attempting to automatically update');
  ...
  it('should detect global bun installation', () => {
    const bunPath = `/Users/test/.bun/install/global/node_modules/@the-a-tech-corporation/a-coder-cli/dist/index.js`;
    ...
    expect(info.isGlobal).toBe(true);
    expect(info.updateCommand).toBe('bun add -g @the-a-tech-corporation/a-coder-cli@latest');
    expect(info.updateMessage).toContain('Attempting to automatically update');
  ...
  it('should default to global npm installation for unrecognized paths', () => {
    ...
    expect(info.packageManager).toBe(PackageManager.NPM);
    expect(info.isGlobal).toBe(true);
    expect(info.updateCommand).toBe('npm install -g @the-a-tech-corporation/a-coder-cli@latest');
    expect(info.updateMessage).toContain('Attempting to automatically update');
  ...
  it('should detect Volta installation (Unix-style)', () => {
    const voltaPath =
      '/Users/test/.volta/tools/image/node/20.0.0/lib/node_modules/@the-a-tech-corporation/a-coder-cli/dist/index.js';
    ...
    expect(info.updateCommand).toBe('volta install @the-a-tech-corporation/a-coder-cli@latest');
  });

  it('should detect Volta installation (Windows-style)', () => {
    const voltaPath =
      'C:\\Users\\test\\AppData\\Local\\Volta\\tools\\image\\node\\20.0.0\\node_modules\\@the-a-tech-corporation/a-coder-cli\\dist\\index.js';
    process.argv[1] = voltaPath;
    mockedRealPathSync.mockReturnValue(voltaPath);
  ...
  it('should NOT detect Homebrew if gemini-cli is installed in brew but running from npm location', () => {
    ...
    const cliPath =
      '/usr/local/lib/node_modules/@the-a-tech-corporation/a-coder-cli/dist/index.js';
    process.argv[1] = cliPath;
