# A-Coder CLI VS Code Companion (`a-coder-ide-companion`)

VS Code extension that pairs with A-Coder CLI, providing direct IDE workspace
...
- Run tests: `npm test -w a-coder-ide-companion`
