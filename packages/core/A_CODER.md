# A-Coder CLI Core (`@the-a-tech-corporation/core`)

Backend logic for A-Coder CLI: API orchestration, prompt construction, tool
...
- Run tests: `npm test -w @the-a-tech-corporation/core`
- Run a specific test:
  `npm test -w @the-a-tech-corporation/core -- src/path/to/file.test.ts`
