    ...
    describe('command hooks', () => {
      ...
      it('should expand environment variables in commands', async () => {
        const configWithEnvVar: HookConfig = {
          type: HookType.Command,
          command: '$A_CODER_PROJECT_DIR/hooks/test.sh',
        };
        ...
        expect(spawn).toHaveBeenCalledWith(
          ...
          expect.objectContaining({
            ...
            env: expect.objectContaining({
              A_CODER_PROJECT_DIR: '/test/project',
              A_CODER_PLANS_DIR: '/test/project/plans',
              A_CODER_CWD: '/test/project',
              A_CODER_SESSION_ID: 'test-session',
      ...
      it('should expand and escape A_CODER_PLANS_DIR in commands', async () => {
        const configWithEnvVar: HookConfig = {
          type: HookType.Command,
          command: 'ls $A_CODER_PLANS_DIR',
        };
      ...
      it('should not allow command injection via A_CODER_PROJECT_DIR', async () => {
        ...
        const config: HookConfig = {
          type: HookType.Command,
          command: 'ls $A_CODER_PROJECT_DIR',
        };
