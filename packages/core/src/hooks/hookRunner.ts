...
export class HookRunner {
  ...
  private async executeCommandHook(
    ...
    return new Promise((resolve) => {
      ...
      const env = {
        ...
        A_CODER_PROJECT_DIR: input.cwd,
        A_CODER_PLANS_DIR: this.config.storage.getPlansDir(),
        A_CODER_CWD: input.cwd,
        A_CODER_SESSION_ID: input.session_id,
  ...
  private expandCommand(
    ...
    return command
      .replace(/\$A_CODER_PROJECT_DIR/g, () => escapedCwd)
      .replace(/\$A_CODER_CWD/g, () => escapedCwd)
      .replace(/\$A_CODER_PLANS_DIR/g, () => escapedPlansDir)
      .replace(/\$A_CODER_SESSION_ID/g, () => escapedSessionId)
