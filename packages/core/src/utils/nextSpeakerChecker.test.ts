...
import { ACoderChat } from '../core/geminiChat.js';
...
describe('checkNextSpeaker', () => {
  ...
  beforeEach(() => {
    ...
    // ACoderChat will receive the mocked instances via the mocked GoogleGenAI constructor
    chatInstance = new ACoderChat(
      mockConfig,
