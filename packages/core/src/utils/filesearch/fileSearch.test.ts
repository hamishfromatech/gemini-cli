...
describe('FileSearch', () => {
  ...
  it('should use .a-coder-ignore rules', async () => {
    tmpDir = await createTmpDir({
      [A_CODER_IGNORE_FILE_NAME]: 'dist/',
      dist: ['ignored.js'],
      src: ['not-ignored.js'],
    });
  ...
  it('should combine .gitignore and .a-coder-ignore rules', async () => {
    tmpDir = await createTmpDir({
      '.git': {},
      '.gitignore': 'dist/',
      [A_CODER_IGNORE_FILE_NAME]: 'build/',
