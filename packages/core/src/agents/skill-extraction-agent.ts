...
function buildSystemPrompt(skillsDir: string, memoryDir: string): string {
  return [
    ...
    '             file ~/.a-coder/A-Coder.md. No other files in ~/.a-coder/ are',
    ...
    '',
    'Project/workspace shared instructions (A-Coder.md and similar files under the',
    ...
    '',
    'NEVER directly edit MEMORY.md, A-Coder.md, ~/.a-coder/A-Coder.md, settings,',
