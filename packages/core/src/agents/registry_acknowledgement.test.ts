...
describe('AgentRegistry Acknowledgement', () => {
  ...
  beforeEach(async () => {
    ...
    // Override A_CODER_CLI_HOME to point to the temp directory
    originalGeminiCliHome = process.env['A_CODER_CLI_HOME'];
    process.env['A_CODER_CLI_HOME'] = tempDir;
  ...
  afterEach(async () => {
    ...
    if (originalGeminiCliHome) {
      process.env['A_CODER_CLI_HOME'] = originalGeminiCliHome;
    } else {
