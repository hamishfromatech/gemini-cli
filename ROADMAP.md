...
The
[Official A-Coder CLI Roadmap](https://github.com/orgs/the-a-tech-corporation/projects/11/)

A-Coder CLI is an open-source AI agent that brings the power of OpenAI-compatible
models directly into your terminal. It provides lightweight access to large
language models, giving you the most direct path from your prompt to your
chosen model.

This document outlines our approach to the A-Coder CLI roadmap. Here, you'll find
...
As an
[Apache 2.0 open source project](https://github.com/hamishfromatech/a-coder-cli?tab=Apache-2.0-1-ov-file#readme),
we appreciate and welcome
[public contributions](https://github.com/hamishfromatech/a-coder-cli/blob/main/CONTRIBUTING.md),
...
[opening an issue for discussion](https://github.com/hamishfromatech/a-coder-cli/issues/new/choose).
...
- **Power & Simplicity:** Deliver access to state-of-the-art OpenAI-compatible models with
...
- **Intelligent:** A-Coder CLI should be reliably ranked among the best agentic
...
Roadmap Issue [here](https://github.com/hamishfromatech/a-coder-cli/issues/4191).
...
all our items [here](https://github.com/orgs/the-a-tech-corporation/projects/11/views/19)
...
- **Authentication:** Secure user access via API keys, A-Coder CLI account login,
  etc.
- **Model:** Support new OpenAI-compatible models, multi-modality, local execution, and
  performance tuning.
...
- **Extensibility:** Bringing A-Coder CLI to other surfaces e.g. GitHub.
...
A-Coder CLI is an open-source project, and we welcome contributions from the
community! Whether you're a developer, a designer, or just an enthusiastic user
you can find our
[Community Guidelines here](https://github.com/hamishfromatech/a-coder-cli/blob/main/CONTRIBUTING.md)
to learn how to get started. There are many ways to get involved:

- **Roadmap:** Please review and find areas in our
  [roadmap](https://github.com/hamishfromatech/a-coder-cli/issues/4191) that you
...
- **Report Bugs:** If you find an issue, please create a
  [bug](https://github.com/hamishfromatech/a-coder-cli/issues/new?template=bug_report.yml)
...
- **Suggest Features:** Have a great idea? We'd love to hear it! Open a
  [feature request](https://github.com/hamishfromatech/a-coder-cli/issues/new?template=feature_request.yml).
- **Contribute Code:** Check out our
  [CONTRIBUTING.md](https://github.com/hamishfromatech/a-coder-cli/blob/main/CONTRIBUTING.md)
...
- **Write Documentation:** Help us improve our documentation, tutorials, and
  examples. We are excited about the future of A-Coder CLI and look forward to
