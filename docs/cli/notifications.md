...
A-Coder CLI can send system notifications to alert you when a session completes
...
[Plan Mode](./plan-mode.md), letting you switch to other windows while A-Coder
...
notifications, A-Coder CLI falls back to a terminal bell (BEL) to get your
...
A-Coder CLI sends notifications for the following events:
