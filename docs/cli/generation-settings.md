...
This guide details the Model Configuration system within A-Coder CLI. Designed
...
| :---------------------- | :------- | :------------------------------------------------------------------------ |
| `model`                 | `string` | The identifier of the model to be called (for example, `a-coder-cli-2.5-pro`). |
...
"modelConfigs": {
  "overrides": [
    {
      "match": {
        "model": "a-coder-cli-2.5-pro"
      },
      "modelConfig": {
        "model": "a-coder-cli-2.5-pro-experimental-001"
      }
    }
  ]
}
