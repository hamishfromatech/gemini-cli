...
A-Coder CLI includes a Checkpointing feature that automatically saves a snapshot
...
1.  **A Git snapshot:** A commit is made in a special, shadow Git repository
    located in your home directory (`~/.a-coder-cli/history/<project_hash>`). This
...
`~/.a-coder-cli/tmp/<project_hash>/checkpoints`.
