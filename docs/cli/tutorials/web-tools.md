...
A-Coder uses the `google_web_search` tool to find relevant pages and synthesizes
...
A-Coder will retrieve the page content (stripping away ads and navigation) and
