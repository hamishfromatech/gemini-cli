...
Model steering lets you provide real-time guidance and feedback to A-Coder CLI
...
1.  Type `/settings` in A-Coder CLI.
...
When model steering is enabled, A-Coder CLI treats any text you type while the
...
A-Coder CLI acknowledges your hint with a brief message and injects it directly
...
When you submit a steering hint, A-Coder CLI performs the following actions:
