...
This monorepo contains two main packages: `@the-a-tech-corporation/a-coder-cli` and
`@the-a-tech-corporation/a-coder-cli-core`.

## `@the-a-tech-corporation/a-coder-cli`

This is the main package for A-Coder CLI. It is responsible for the user
...
`@the-a-tech-corporation/a-coder-cli-core`. This means that whether a user installs the package
with `npm install -g @the-a-tech-corporation/a-coder-cli` or runs it directly with
`npx @the-a-tech-corporation/a-coder-cli`, they are using this single, self-contained executable.

## `@the-a-tech-corporation/a-coder-cli-core`

This package contains the core logic for interacting with the A-Coder API. It is
...
- **Simplified script execution**: You can run scripts in any package from the
  ...
  `npm run build --workspace @the-a-tech-corporation/a-coder-cli`.
