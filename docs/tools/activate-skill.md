...
The `activate_skill` tool lets A-Coder CLI load specialized procedural expertise
...
tasks, such as reviewing code or creating pull requests. A-Coder CLI uses this
...
The `activate_skill` tool is used exclusively by the A-Coder agent. You cannot
