...
This document provides the technical specification for A-Coder CLI hooks,
...
A-Coder CLI uses these structures to ensure hooks don't break across SDK updates.
