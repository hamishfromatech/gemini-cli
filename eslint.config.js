          ...
          paths: [
            {
              ...
              message:
                'Please use the helpers from @the-a-tech-corporation/a-coder-cli-core instead of node:os homedir()/tmpdir() to ensure strict environment isolation.',
            },
            {
              name: 'os',
              importNames: ['homedir', 'tmpdir'],
              message:
                'Please use the helpers from @the-a-tech-corporation/a-coder-cli-core instead of os homedir()/tmpdir() to ensure strict environment isolation.',
            },
          ],
        },
      ],
  ...
  },
  {
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          name: '@the-a-tech-corporation/a-coder-cli-core',
          message: 'Please use relative imports within the @the-a-tech-corporation/a-coder-cli-core package.',
        },
      ],
    },
  },
  {
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          name: '@the-a-tech-corporation/a-coder-cli',
          message: 'Please use relative imports within the @the-a-tech-corporation/a-coder-cli package.',
        },
      ],
    },
  },
  {
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          name: '@the-a-tech-corporation/a-coder-cli-sdk',
          message: 'Please use relative imports within the @the-a-tech-corporation/a-coder-cli-sdk package.',
        },
      ],
    },
  },
