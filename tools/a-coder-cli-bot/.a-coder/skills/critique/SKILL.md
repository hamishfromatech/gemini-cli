...
17. **Policy Compliance (GCLI Classification)**: If a script utilizes A-Coder CLI
    for classification, ensure it does NOT use the specialized
    `tools/a-coder-cli-bot/ci-policy.toml`. It must rely on default or workspace
...
- **Update Structured Memory**: You MUST record your decision and reasoning in
  `tools/a-coder-cli-bot/lessons-learned.md` using the **Structured Markdown**
