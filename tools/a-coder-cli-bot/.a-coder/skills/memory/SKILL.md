...
Standardize how the A-Coder CLI Bot maintains its persistent memory,
...
You MUST maintain `tools/a-coder-cli-bot/lessons-learned.md` using the following
...
1.  **Read Memory**: Read `tools/a-coder-cli-bot/lessons-learned.md`.
...
1.  **Record Findings**: You MUST update `tools/a-coder-cli-bot/lessons-learned.md`
