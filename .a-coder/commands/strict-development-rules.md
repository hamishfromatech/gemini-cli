# A-Coder CLI Strict Development Rules
...
- **Keyboard Handling**: Keyboard handling MUST go through `useKeyPress.ts` from
  the A-Coder CLI package rather than the standard ink library. This library
...
## General A-Coder CLI Design Principles
...
- **Prompts**: Be aware that changes can impact the prompts sent to A-Coder CLI
