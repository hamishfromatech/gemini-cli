...
name: ci
description:
  A specialized skill for A-Coder CLI that provides high-performance, fail-fast
...
- **Tool**: `node .a-coder/skills/ci/scripts/ci.mjs [branch]`
...
- **Tool**: `node .a-coder/skills/ci/scripts/ci.mjs [branch] [run_id]`
- **Discovery**: The script **automatically** finds the latest active or recent
