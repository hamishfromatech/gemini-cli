...
import { ApprovalMode, isRecord } from '@the-a-tech-corporation/core';
...
describe('ask_user', () => {
  ...
  askUserEvalTest('USUALLY_PASSES', {
    ...
    files: {
      ...
      'packages/core/package.json': JSON.stringify({
        name: '@the-a-tech-corporation/core',
      }),
      'README.md': '# A-Coder CLI',
    },
  ...
  // See fix: https://github.com/hamishfromatech/a-coder-cli/pull/20504
  askUserEvalTest('USUALLY_PASSES', {
    suiteName: 'default',
    suiteType: 'behavioral',
